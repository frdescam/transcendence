...
import { inject, onBeforeUnmount, onMounted, reactive, readonly } from 'vue';
...
const props = defineProps<{ userId: userId, username?: string }>();
...
@TODO:
- Use vue's computed
- Aliasing / destructuring `state.party`
- Split into lower and reusable components
- Cleanup
*/
...
<template>
  <q-card class="bg-grey-2">
    <q-card-section>
      <div class="text-h6" v-if="$props.username">{{$props.username}}'s status</div>
